local SCRIPT_TITLE = 'Shift parameters up V1.0'

--[[

Synthesizer V Studio Pro Script
 
lua file name: ShiftParametersUp.lua

This script will move the offset parameters to upper

Set shortcut to ALT + cursor up
...
LocalObject = {
	currentMode = 1,	-- 1=up 2=down 3=left 4=right
