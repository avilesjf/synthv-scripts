...
Warning:
Do not try to run this script directly!!
...
function getClientInfo()
	return {
		-- name = SV:T(SCRIPT_TITLE), -- Only a module of ShiftParametersModule UP/DOWN/LEFT/RIGHT
		-- category = "_JFA_Modules", -- Not displayed in scripts list
		author = "JFAVILES",
		versionNumber = 1,
