local SCRIPT_TITLE = 'Shift parameters left V1.0'

--[[

Synthesizer V Studio Pro Script
 
lua file name: ShiftParametersLeft.lua

This script will move the offset parameters to the left
...
LocalObject = {
	currentMode = 3,	-- 1=up 2=down 3=left 4=right
