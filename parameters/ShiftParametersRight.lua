local SCRIPT_TITLE = 'Shift parameters right V1.0'

--[[

Synthesizer V Studio Pro Script
 
lua file name: ShiftParametersRight.lua

This script will move the offset to the right
...
LocalObject = {
	currentMode = 4,	-- 1=up 2=down 3=left 4=right
