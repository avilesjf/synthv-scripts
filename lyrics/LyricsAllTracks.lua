local SCRIPT_TITLE = 'Lyrics All tracks to Clipboard V1.0'

--[[

Synthesizer V Studio Pro Script
 
lua file name: LyricsAllTracks.lua

Copy into clipboard, all lyrics inside all group of notes
in text format for all tracks.
	...
	if #lyricsTable > 0 then
		...
		for iGroups = 1, #lyricsTable do
			if lyricsTable[iGroups].lyric ~= previousLyrics or 
				...
				.. "Track: " .. "(" .. string.format("%02d", lyricsTable[iGroups].trackNumber) .. ") " .. string.format("%-20s", lyricsTable[iGroups].trackName) .. " "
				.. "Group: " .. "(" .. string.format("%02d", lyricsTable[iGroups].groupIndex) .. ") " .. "\r"
				--.. "Group: " .. "(" .. string.format("%02d", lyricsTable[iGroups].groupIndex) ..") " .. lyricsTable[iGroups].lyric
